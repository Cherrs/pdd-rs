...
pub struct SkuList {
    ...
    pub spec_id_list: Option<String>,
...
impl Request for PddGoodsAdd {
    fn get_type() -> String {
        "pdd.goods.add".to_string()
    }

    fn get_response_name() -> String {
        "goods_add_response".to_string()
    }
}
